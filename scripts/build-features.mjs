...
const outDir = resolve(__dirname, "..", "src", "baseline");
mkdirSync(outDir, { recursive: true });

// Write TS with header banner (human-readable, do-not-edit notice)
const header =
  "/**\n * @fileoverview JavaScript features extracted from the web-features package.\n * @author scripts/build-features.mjs\n *\n * THIS FILE IS AUTOGENERATED. DO NOT MODIFY DIRECTLY.\n */";
const tsBody = `${header}\n\nexport default ${JSON.stringify(out, null, 2)} as const;\n`;
const outTs = resolve(outDir, "features.ts");
writeFileSync(outTs, tsBody, "utf-8");

console.log(`Wrote ${Object.keys(out).length} features to ${outTs}`);
