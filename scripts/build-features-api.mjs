...
const entries = Object.entries(wfFeatures).filter(
  ([, f]) =>
    ...
    f.compat_features.some((k) => typeof k === "string" && k.startsWith("api.")),
);
...
const outPath = resolve(__dirname, "..", "src", "baseline", "data", "features.api.ts");
mkdirSync(dirname(outPath), { recursive: true });
writeFileSync(outPath, body, "utf-8");
console.log(`Wrote ${Object.keys(out).length} Web API features to ${outPath}`);
