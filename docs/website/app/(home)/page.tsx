  ...
  return (
    <main className="flex flex-1 flex-col items-center justify-center px-6 py-16 text-center gap-2">
      ...
      <div className="mx-auto max-w-3xl">
        ...
        {/* Code demo */}
        <div className="mx-auto max-w-4xl overflow-hidden rounded-2xl border bg-fd-card text-left  ring-1 ring-white/5 [box-shadow:0_30px_100px_-10px_rgba(99,102,241,0.25)]">
          <div className="border-b px-6 py-3 text-sm md:text-base text-fd-muted-foreground">
            example.ts
          </div>
          <pre className="overflow-auto p-6 text-base md:text-lg leading-8 mb-2">
            <code>
              {"const date = new Date();\n"}
              {"const year = "}
          ...
          <div className="border-t bg-fd-card px-6 py-4 text-sm md:text-base">
            <p className="flex items-start gap-3 text-rose-500">
